...
// Tests locaux: le rendu de prompt est un helper prive partage par les commandes;
// les tests d'integration couvrent les prompts via parse_args et le binaire.
#[cfg(test)]
mod tests {
    use super::{PromptSection, render_prompt, render_structured_prompt};
